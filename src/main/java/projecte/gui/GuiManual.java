...
public class GuiManual extends GuiScreen {
    ...
    private void updateButtons() {
        ...
        next.visible = (pageIndex < bookTotalPages - 1);
    ...
    /*
     * Example of using a localized string: fontRenderObj.drawString(TextHelper.localize("info.flowstoneenergy.manual.page.one")); That will display
     * the localization on line 152 of en_US.lang Now you just need to get drawSplitString to work :D
     */
...
//        fontRendererObj.setUnicodeFlag(unicode);
    ...
    protected void RenderItem(RenderItem itemRenderer, int x, int y, Item food) {
        ...
        itemRenderer
                .renderItemIntoGUI(Minecraft.getMinecraft().fontRenderer, Minecraft.getMinecraft().renderEngine, new ItemStack(food), x, y, false);
    }
    
    @SideOnly(Side.CLIENT)
    public static class GuiButtonPageChange extends GuiButton {
