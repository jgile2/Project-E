...
public class BlockRelayMK3 extends BlockContainer {
	private Random rand = new Random();

	protected BlockRelayMK3() {
		super(Material.iron);
		this.setBlockName(ModInfo.MOD_ID + ".relayMK3");
	...
	public void registerBlockIcons(IIconRegister icon) {
		...
		topIcon = icon.registerIcon(ModInfo.MOD_ID + ":relay_topMK3");
