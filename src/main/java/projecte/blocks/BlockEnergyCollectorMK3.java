...
public class BlockEnergyCollectorMK3 extends BlockContainer {
	private Random rand = new Random();

	protected BlockEnergyCollectorMK3() {
		super(Material.iron);
		this.setBlockName(ModInfo.MOD_ID + ".energyCollectorMK3");
	...
	public void registerBlockIcons(IIconRegister icon) {
		...
		topIcon = icon.registerIcon(ModInfo.MOD_ID + ":energyCollectorMK3_top");
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEnergyCollectorMK3();
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int oldMetadata) {
		...
		TileEnergyCollectorMK3 te = (TileEnergyCollectorMK3) world.getTileEntity(x, y, z);
