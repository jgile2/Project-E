...
public class EnergyCollectorMK1 extends BlockContainer {

	protected EnergyCollectorMK1() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister icon) {
		this.blockIcon = icon.registerIcon(ModInfo.MOD_ID + ":energyCollectorMK1_side");
		topIcon = icon.registerIcon(ModInfo.MOD_ID + ":energyCollectorMK1_top");
		sideIcon = icon.registerIcon(ModInfo.MOD_ID + ":energyCollectorMK1_side");
		frontIcon = icon.registerIcon(ModInfo.MOD_ID + ":energyCollectorMK1_front");
	}
